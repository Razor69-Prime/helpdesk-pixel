/* PXL-URG-0049 — Master Pricelist menu controlled by Account Management permission. */
(function(){
  'use strict';
  const REV='PXL-URG-0049';
  ...
  function ensureMenu(){
    ...
    if(!btn){
      ...
      btn.dataset.pxlMasterPricelist='0049';
    ...
    }else btn.dataset.pxlMasterPricelist='0049';
