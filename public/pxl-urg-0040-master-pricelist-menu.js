/* PXL-URG-0040D — Isolated Master Pricelist trial menu. Superadmin only. No Pricing/Inventory/SO integration. */
(function(){
  'use strict';
  const REV='PXL-URG-0040D';
  ...
  function ensureMenu(){
    ...
    if(!btn){
      ...
      btn.dataset.pxlMasterPricelist='0040D';
    ...
    }else btn.dataset.pxlMasterPricelist='0040D';
