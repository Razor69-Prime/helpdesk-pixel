/* PXL-URG-0045 — Isolated Master Pricelist trial menu. Superadmin only. No Pricing/Inventory/SO integration. */
(function(){
  'use strict';
  ...
  function ensureMenu(){
    ...
    if(!btn){
      ...
      btn.dataset.pxlMasterPricelist='0045';
    ...
    }else btn.dataset.pxlMasterPricelist='0045';
