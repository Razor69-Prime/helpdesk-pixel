/* PXL-URG-0040E — Isolated Master Pricelist trial menu. Superadmin only. No Pricing/Inventory/SO integration. */
(function(){
  'use strict';
  const REV='PXL-URG-0040E';
  ...
  function ensureMenu(){
    ...
    if(!btn){
      ...
      btn.dataset.pxlMasterPricelist='0040E';
    ...
    }else btn.dataset.pxlMasterPricelist='0040E';
