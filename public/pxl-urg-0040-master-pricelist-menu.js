/* PXL-URG-0044 — Isolated Master Pricelist trial menu. Superadmin only. No Pricing/Inventory/SO integration. */
(function(){
  'use strict';
  const REV='PXL-URG-0044';
  ...
  function ensureMenu(){
    ...
    if(!btn){
      ...
      btn.dataset.pxlMasterPricelist='0044';
    ...
    }else btn.dataset.pxlMasterPricelist='0044';
