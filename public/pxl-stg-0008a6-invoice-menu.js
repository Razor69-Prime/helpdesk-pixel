/* PXL-STG-0008A8 — kembalikan menu utama Invoice ke halaman Invoice V1. */
(function(){
  'use strict';
  const TARGET='/invoice-v1.html';
  function apply(){
  ...
  document.addEventListener('click',e=>{
    ...
    if(t&&String(t.textContent||'').trim()==='Invoice'){e.preventDefault();location.href=TARGET;}
  },true);
