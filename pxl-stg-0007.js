...
/** PXL-STG-0007Q — Kanban, jadwal, kapasitas, KPI, dan sinkronisasi tanggal saja. */
...
const sharedDate=t=>dateOnly(t?.worked_at)||dateOnly(t?.scheduled_date);
function preserveWorkedTime(workedAt,newDate){const s=String(workedAt||'');if(!newDate||!dateOnly(s)||s.length<=10)return null;return `${newDate}${s.slice(10)}`;}
