...
function forceSalesOrderScriptOrder(html){const bases=['/pxl-stg-0006c-sales-order.js','/pxl-stg-0006k-polish.js','/pxl-stg-0006l-pdf-fix.js','/pxl-urg-0014-sales-order-wo-date.js','/pxl-urg-0014a-sales-order-wo-date-direct.js'];for(const base of bases)html=removeScript(html,base);const ordered=['<script src="/pxl-stg-0006c-sales-order.js?v=PXL-STG-0006N"></script>','<script src="/pxl-stg-0006k-polish.js?v=PXL-PROD-0022PDF5"></script>','<script src="/pxl-stg-0006l-pdf-fix.js?v=PXL-PROD-0022PDF5"></script>','<script src="/pxl-urg-0014-sales-order-wo-date.js?v=PXL-URG-0014"></script>','<script src="/pxl-urg-0014a-sales-order-wo-date-direct.js?v=PXL-URG-0014A"></script>'].join('\n');return html.replace('</body>',ordered+'\n</body>');}
  ...
  return function pxl0008a20Middleware(req,res,next){
    ...
    try{
      ...
      if(isIndex){
        ...
        html=removeScript(html,'/pxl-urg-0015-sales-order-permission-persistence.js');
        ...
        const tags=[
          ...
          '<script src="/pxl-urg-0016a-account-permission-single-source.js?v=PXL-URG-0016A"></script>'
        ];
