...
// PXL-STG-0005H menjadi satu-satunya konsolidator flow baru.
    ...
    try {
      ...
      if (isIndex) {
        const tags = [
          ...
          '<script src="/pxl-stg-0004f.js?v=PXL-STG-0005H"></script>',
          '<script src="/pxl-stg-0005d.js?v=PXL-STG-0005H"></script>'
        ];
