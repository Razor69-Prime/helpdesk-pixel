...
// PXL-STG-0006I — satu tombol PDF Penawaran dan perbaikan edit Draft Sales Order.
// Paket PXL-STG-0006A–0006H dan flow Material Request PXL-STG-0005 tetap aktif.
    ...
    try {
      ...
      if (isIndex) {
        const tags = [
          ...
          '<script src="/pxl-stg-0004f.js?v=PXL-STG-0006I"></script>',
          '<script src="/pxl-stg-0005d.js?v=PXL-STG-0006I"></script>',
      ...
      if (isSalesOrder && !html.includes('/pxl-stg-0006c-sales-order.js')) {
        html = html.replace(
          '</body>',
          '<script src="/pxl-stg-0006c-sales-order.js?v=PXL-STG-0006I"></script>\n</body>'
        );
      } else if (isSalesOrder) {
        html = html.replace(
          /\/pxl-stg-0006c-sales-order\.js\?v=[^"']+/g,
          '/pxl-stg-0006c-sales-order.js?v=PXL-STG-0006I'
        );
      }
      ...
      if (isCrm && !html.includes('/pxl-stg-0006e-crm.js')) {
        html = html.replace(
          '</body>',
          '<script src="/pxl-stg-0006e-crm.js?v=PXL-STG-0006I"></script>\n</body>'
        );
      } else if (isCrm) {
        html = html.replace(
          /\/pxl-stg-0006e-crm\.js\?v=[^"']+/g,
          '/pxl-stg-0006e-crm.js?v=PXL-STG-0006I'
        );
      }
