...
// PXL-STG-0006G — stabilisasi tombol Submit dan Unduh PDF pada Sales Order.
    ...
    try {
      ...
      if (isIndex) {
        const tags = [
          ...
          '<script src="/pxl-stg-0004f.js?v=PXL-STG-0006G"></script>',
          '<script src="/pxl-stg-0005d.js?v=PXL-STG-0006G"></script>',
      ...
      if (isSalesOrder && !html.includes('/pxl-stg-0006c-sales-order.js')) {
        html = html.replace(
          '</body>',
          '<script src="/pxl-stg-0006c-sales-order.js?v=PXL-STG-0006G"></script>\n</body>'
        );
      } else if (isSalesOrder) {
        html = html.replace(
          /\/pxl-stg-0006c-sales-order\.js\?v=[^"']+/g,
          '/pxl-stg-0006c-sales-order.js?v=PXL-STG-0006G'
        );
      }

      if (isSalesOrder && !html.includes('/pxl-stg-0006g-sales-order.js')) {
        html = html.replace(
          '</body>',
          '<script src="/pxl-stg-0006g-sales-order.js?v=PXL-STG-0006G"></script>\n</body>'
        );
      }
      ...
      if (isCrm && !html.includes('/pxl-stg-0006e-crm.js')) {
        html = html.replace(
          '</body>',
          '<script src="/pxl-stg-0006e-crm.js?v=PXL-STG-0006G"></script>\n</body>'
        );
      } else if (isCrm) {
        html = html.replace(
          /\/pxl-stg-0006e-crm\.js\?v=[^"']+/g,
          '/pxl-stg-0006e-crm.js?v=PXL-STG-0006G'
        );
      }
