...
function forceSalesOrderScriptOrder(html){
  const bases=['/pxl-stg-0006c-sales-order.js','/pxl-stg-0006k-polish.js','/pxl-stg-0006l-pdf-fix.js','/pxl-urg-0014-sales-order-wo-date.js','/pxl-urg-0014a-sales-order-wo-date-direct.js','/pxl-urg-0019-native-wo-date.js','/pxl-urg-0021-sales-order-manual-material-maps.js','/pxl-urg-0030-pricing-calculator.js'];
  ...
  const ordered=[
    ...
    '<script src="/pxl-urg-0030-pricing-calculator.js?v=PXL-URG-0030"></script>'
  ].join('\n');
    ...
    try{
      ...
      if(isIndex){
        ...
        const tags=[
          ...
          '<script src="/pxl-urg-0032b-remarks-layout.js?v=PXL-URG-0032F"></script>'
        ];
