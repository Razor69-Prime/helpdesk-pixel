...
// PXL-STG-0007H — Kanban mandiri dengan autentikasi JWT existing.
    ...
    try {
      ...
      if (isIndex) {
        ...
        const tags = [
          ...
          '<script src="/pxl-stg-0004f.js?v=PXL-STG-0007H"></script>',
          ...
          '<script src="/pxl-stg-0006k-polish.js?v=PXL-STG-0006N"></script>',
          '<script src="/pxl-stg-0006l-pdf-fix.js?v=PXL-STG-0006N"></script>',
          '<script src="/pxl-stg-0007h-auth.js?v=PXL-STG-0007H"></script>',
          '<script src="/pxl-stg-0007-kanban.js?v=PXL-STG-0007H"></script>'
        ];
        for (const tag of tags) {
          const src = tag.match(/src="([^"]+)/)?.[1];
          if (!src) continue;
          const base = src.split('?')[0];
          html = replaceOrAppendScript(html, base, src.split('?v=')[1] || 'PXL-STG-0007H');
        }
      }
