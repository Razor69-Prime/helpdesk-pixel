...
// PXL-STG-0006F — paket lengkap Quotation, routing WO/MR, Customer 360, dan UAT.
// PXL-STG-0005 tetap aktif sebagai flow Material Request stabil.
    ...
    try {
      ...
      if (isIndex) {
        const tags = [
          ...
          '<script src="/pxl-stg-0004f.js?v=PXL-STG-0006F"></script>',
          '<script src="/pxl-stg-0005d.js?v=PXL-STG-0006F"></script>',
      ...
      if (isSalesOrder && !html.includes('/pxl-stg-0006c-sales-order.js')) {
        html = html.replace(
          '</body>',
          '<script src="/pxl-stg-0006c-sales-order.js?v=PXL-STG-0006F"></script>\n</body>'
        );
      }
      ...
      if (isCrm && !html.includes('/pxl-stg-0006e-crm.js')) {
        html = html.replace(
          '</body>',
          '<script src="/pxl-stg-0006e-crm.js?v=PXL-STG-0006F"></script>\n</body>'
        );
      }
